...
export class DimentionalPhone implements ItemCustomComponent {
    async onUse({ source }: ItemComponentUseEvent) {
        const form = new ActionFormData()
            .title("Dimentional Phone")
            .body("Select option")
            .button("Home", "textures/items/scroll/recall_scroll")
            ...
            .button("Nether", "textures/items/scroll/scroll_of_pain")
            .button("The end", "textures/items/scroll/the_end_scroll");
		try {
